...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3><a href="../index.php" class="navbar-brand headerFont text-lg" style="color: white;"><strong><img itemprop="image" class="mobile" src="https://susa.strathmore.edu/wp-content/uploads/2019/09/studentaffairslogo.png" alt="Logo" style="height: 50%;"></strong></a></h3>
